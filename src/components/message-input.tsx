  ...
  return (
    <div className=" flex flex-col mt-4 gap-y-2">
      ...
      <textarea
        ...
        className=" rounded-lg w-full ring-2 ring-neutral-200 focus:outline-none focus:ring-primary text-sm p-4 py-2.5 dark:ring-neutral-800 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100"
